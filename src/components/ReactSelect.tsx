...
const DropdownIndicator = (props: DropdownIndicatorProps) => {
    return (
        <components.DropdownIndicator {...props}>
            {/* <ChevronDownIcon /> */}
            <img src="down-arrow-select.svg" alt="" />
...
const controlStyles = {
    base: "border rounded-[15px] border-[#E8E6EA]  bg-white hover:cursor-pointer",
...
const ReactSelect: FC<ReusableSelectProps> = ({
    ...
    return (
        <div>
            <div className='mb-3' />
            {label && <label className='text-base leading-6 font-medium mb-10 ml-1 text-[#1F1F39]' htmlFor={name}>{label}</label>}
            <div className='my-2' />
            <Select
                defaultValue={value}
                value={value}
